...
@HiltViewModel
class SignUpViewModel @Inject constructor(private val profileUseCase: ProfileUseCase) : ViewModel()  {
    ...
    private var _rememberPwEqualOrNot = mutableStateOf(false)
    private var _rememberTrigger = mutableStateOf(false)
